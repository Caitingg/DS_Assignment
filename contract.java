...
public class contract {
    ...
    public void initialise(Connection con,int id){
        ...
        try {
            String sql="SELECT Player_ID,Player_Name,Start_Date,End_Date,Status,Injury_Reserved FROM teamplayer WHERE User_ID="+userId;
            ...
            while(rs.next()){
                ...
                team.add(new TeamPlayer(playerID,playerName,sd,ed,tl,status,injury,id));
            }  
